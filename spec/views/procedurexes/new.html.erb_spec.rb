...
describe "procedurexes/new" do
  before(:each) do
    assign(:procedurex, stub_model(Procedurex,
      :name => "MyString",
      :astmip => "MyString",
      :subtype => "MyString",
      :description => "MyText",
  ...
  it "renders new procedurex form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => procedurexes_path, :method => "post" do
